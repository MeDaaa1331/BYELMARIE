const translations = {
  cs: {
    ...
    nav_products_rollers: 'CELLSLIMROLL®',
    ...
    cat_title: 'Pro podnikání & Domácí použití',
    cat_body_care: 'Pro domácí & profesionální použití',
    cat_body_care_desc: 'Baňky, válečky a séra pro péči o tělo',
    cat_professional: 'Pro podnikání',
  ...
  en: {
    ...
    cat_body_care: 'For Home & Professional Use',
    cat_body_care_desc: 'Cups, rollers and serums for body care',
    cat_professional: 'For Business',
    ...
    cat_title: 'For Business & Home Use',
